...
本目录是 KeyCertHub 的设计与交付文档。

**主设计文档**：[`00-总体设计与实施路线图.md`](00-总体设计与实施路线图.md)
— 功能范围（210 项功能矩阵）、版本规划与阶段路线图的**唯一事实来源**。其余文档不重复定义范围，只做展开与细化。
...
| 文档 | 内容 | 对应主文档章节 | 阶段 | 状态 |
|---|---|---|---|:--:|
| [00-总体设计与实施路线图.md](00-总体设计与实施路线图.md) | **主设计文档**：210 项功能矩阵、版本规划、阶段 0–8 路线图、验收标准 | — | 0–8 | ✅ |
...
| [references.md](references.md) | 参考资料与上游项目溯源（OpenSSL / GmSSL / OpenBao） | — | 0 | ✅ |
